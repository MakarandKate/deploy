...
exports.Temp20Estimate = void 0;
var ReferenceData_1 = require("../utils/ReferenceData");
var commonTempData_1 = require("./commonTempData");
var Temp20Estimate = /** @class */ (function () {
    function Temp20Estimate(data) {
        this.data = data;
        this.totalSaving = 0;
    ...
    Temp20Estimate.prototype.main = function () {
    ...
    Temp20Estimate.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle());
    };
    Temp20Estimate.prototype.footer = function () {
    ...
    Temp20Estimate.prototype.templateBody = function () {
    ...
    Temp20Estimate.prototype.commonTwoRowDetails = function (title, value) {
        return "\n          <div class=\"col-xs-9\" style=\"text-align:right\">".concat(title, "</div>\n          <div class=\"col-xs-3\" style=\"text-align:right\">").concat(value, "</div>\n      ");
    };
    Temp20Estimate.prototype.commonTaxAndAmtDetails = function (title, value) {
    ...
    Temp20Estimate.prototype.itemRow = function (invoiceItem) {
    ...
    Temp20Estimate.prototype.sellerDetails = function () {
    ...
    Temp20Estimate.prototype.invoiceTitle = function () {
    ...
    Temp20Estimate.prototype.commonDateFormat = function (dateName, timeStamp) {
    ...
    return Temp20Estimate;
}());
exports.Temp20Estimate = Temp20Estimate;
//# sourceMappingURL=temp20-estimate.js.map