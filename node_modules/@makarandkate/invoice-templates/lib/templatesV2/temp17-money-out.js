...
exports.Temp17MoneyOut = void 0;
var commonTempData_1 = require("./commonTempData");
var Temp17MoneyOut = /** @class */ (function () {
    function Temp17MoneyOut(data) {
        this.data = data;
        this.totalSaving = 0;
    }
    Temp17MoneyOut.prototype.main = function () {
    ...
    Temp17MoneyOut.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle());
    };
    Temp17MoneyOut.prototype.footer = function () {
    ...
    Temp17MoneyOut.prototype.templateBody = function () {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        html = '';
                        html += "\n          \n          <div class=\"col-xs-12\" style=\"text-align:center\">\n          <hr/>\n            <b  class=\"text-3i-h2\">\n              Paid : ".concat(commonTempData_1.commonTempData.unitAdjuster((_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a.bill) === null || _b === void 0 ? void 0 : _b.totalAmount), "\n            </b>\n          <hr/>\n          </div>\n          \n          ");
    ...
    Temp17MoneyOut.prototype.commonTwoRowDetails = function (title, value) {
        return "\n          <div class=\"col-xs-9\" style=\"text-align:right\">".concat(title, "</div>\n          <div class=\"col-xs-3\" style=\"text-align:right\">").concat(value, "</div>\n      ");
    };
    Temp17MoneyOut.prototype.commonTaxAndAmtDetails = function (title, value) {
    ...
    Temp17MoneyOut.prototype.sellerDetails = function () {
    ...
    Temp17MoneyOut.prototype.invoiceTitle = function () {
    ...
    Temp17MoneyOut.prototype.commonDateFormat = function (dateName, timeStamp) {
    ...
    Temp17MoneyOut.prototype.commonDateFormat2 = function (dateName, timeStamp) {
        return "\n        <div\n          style=\"display: flow-root;font-weight: bold;color: #000;width: 50%;float: left;\"\n          class=\"f-14 f-b m-5 text-3i-h2\">\n            ".concat(dateName, " :\n          </div>\n\n          <div\n          style=\"display: flow-root;color: #000;width: 50%;float: left;text-align: right;\"\n          class=\"f-14 m-5 text-3i-h2\">\n             ").concat(commonTempData_1.commonTempData.dateToDDMMYY(timeStamp), "\n        </div>\n      ");
    };
    return Temp17MoneyOut;
}());
exports.Temp17MoneyOut = Temp17MoneyOut;
//# sourceMappingURL=temp17-money-out.js.map