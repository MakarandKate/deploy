...
exports.Temp20MoneyOut = void 0;
var commonTempData_1 = require("./commonTempData");
var Temp20MoneyOut = /** @class */ (function () {
    function Temp20MoneyOut(data) {
        this.data = data;
        this.totalSaving = 0;
    }
    Temp20MoneyOut.prototype.main = function () {
    ...
    Temp20MoneyOut.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle());
    };
    Temp20MoneyOut.prototype.footer = function () {
    ...
    Temp20MoneyOut.prototype.templateBody = function () {
    ...
    Temp20MoneyOut.prototype.invoiceTitle = function () {
    ...
    Temp20MoneyOut.prototype.commonDateFormat = function (dateName, timeStamp) {
    ...
    return Temp20MoneyOut;
}());
exports.Temp20MoneyOut = Temp20MoneyOut;
//# sourceMappingURL=temp20-money-out.js.map