...
exports.Temp1MoneyOut = void 0;
var commonTempData_1 = require("./commonTempData");
var Temp1MoneyOut = /** @class */ (function () {
    function Temp1MoneyOut(data) {
        this.data = data;
    }
    Temp1MoneyOut.prototype.main = function () {
    ...
    Temp1MoneyOut.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle(), "\n        ").concat(this.partyDetails(), " \n      ");
    };
    Temp1MoneyOut.prototype.footer = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Temp1MoneyOut.prototype.sellerDetails = function () {
    ...
    Temp1MoneyOut.prototype.templateBody = function () {
        var html = '';
    ...
    Temp1MoneyOut.prototype.invoiceTitle = function () {
        var _a, _b, _c, _d;
        var html = '';
    ...
    Temp1MoneyOut.prototype.partyDetails = function () {
        ...
        if ((_g = (_f = this.data) === null || _f === void 0 ? void 0 : _f.bill) === null || _g === void 0 ? void 0 : _g.billNo) {
            var title = "Receipt No";
            html += this.commonRightSideFormatForPartyDetails(title, (_h = this.data) === null || _h === void 0 ? void 0 : _h.bill.billNo);
        }
        html += "<div\n            style=\"display: flow-root;font-weight: bold;font-size: 14px;color: #000;width: 50%;float: left;\"\n            class=\"f-14 f-b m-5-new\">\n              Created On :\n            </div>\n      \n            <div\n            style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left;text-align: right;\"\n            class=\"f-14 m-5-new\">\n               ".concat(commonTempData_1.commonTempData.dateToDDMMYYYHHMMAP((_k = (_j = this.data) === null || _j === void 0 ? void 0 : _j.bill) === null || _k === void 0 ? void 0 : _k.createdStamp), "\n            </div>");
        var isBillDateDiff = commonTempData_1.commonTempData.isBillDateDiff((_m = (_l = this.data) === null || _l === void 0 ? void 0 : _l.bill) === null || _m === void 0 ? void 0 : _m.createdStamp, (_p = (_o = this.data) === null || _o === void 0 ? void 0 : _o.bill) === null || _p === void 0 ? void 0 : _p.billDateStamp);
        if (isBillDateDiff && ((_r = (_q = this.data) === null || _q === void 0 ? void 0 : _q.bill) === null || _r === void 0 ? void 0 : _r.billDateStamp)) {
            html += this.commonDateFormat('Date', (_t = (_s = this.data) === null || _s === void 0 ? void 0 : _s.bill) === null || _t === void 0 ? void 0 : _t.billDateStamp);
        }
        // div2 closed
        html += "</div>";
        // main div closed
    ...
    Temp1MoneyOut.prototype.footerCalculationForMoneyIn = function () {
        ...
        html += "\n      <div style=\"display: flow-root;font-weight: bold;font-size: 14px;color: #000;text-transform: capitalize;\"\n      class=\"f-14 f-b\">\n        Amount in Words\n      </div>\n      <div style=\"display: flow-root;font-size: 14px;color: #000;text-transform: capitalize;\" class=\"f-14\">\n       ".concat(commonTempData_1.commonTempData.convertToIndianCurrency(((_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a.bill) === null || _b === void 0 ? void 0 : _b.totalAmount).toString()), "\n        </div>");
        //closing div1
        html += "</div>";
        //Naming this div as div2, close it after applying conditions
        html += " <div style=\"display: flow-root;width: 50%;align-items: flex-start;flex-wrap: wrap;\">";
        html += this.commonAmountCalculationFormatForFooterForMoneyIn('Paid:', commonTempData_1.commonTempData.unitAdjuster(((_d = (_c = this.data) === null || _c === void 0 ? void 0 : _c.bill) === null || _d === void 0 ? void 0 : _d.totalAmount) || 0));
        html += this.commonAmountCalculationFormatForFooterForMoneyIn('Mode:', (_f = (_e = this.data) === null || _e === void 0 ? void 0 : _e.bill) === null || _f === void 0 ? void 0 : _f.txnMode);
        if ((_h = (_g = this.data) === null || _g === void 0 ? void 0 : _g.bill) === null || _h === void 0 ? void 0 : _h.txnRef) {
            html += this.commonAmountCalculationFormatForFooterForMoneyIn('Cheque No:', (_k = (_j = this.data) === null || _j === void 0 ? void 0 : _j.bill) === null || _k === void 0 ? void 0 : _k.txnRef);
        }
        html += "</div>";
        //closing main div
        html += "</div>";
    ...
    Temp1MoneyOut.prototype.footerBankDetails = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var obj, html, qrCodeBase64;
    ...
    Temp1MoneyOut.prototype.footerTNCAndNotes = function () {
        var _a, _b, _c, _d;
    ...
    Temp1MoneyOut.prototype.commmonTNCAndNotesFormat = function (title, value, sectionClassName) {
    ...
    Temp1MoneyOut.prototype.commonBankDetailsFormatForFooter = function (text) {
        return " <div style=\"font-size: 12px;width: 100%;\" class=\"f-16\">".concat(text, "</div>");
    };
    Temp1MoneyOut.prototype.commonSignatureFormatForFooter = function (imgBase64, title) {
        ...
        return "\n      <div style=\"display: flow-root;width: 27%;float: left;padding: 0 20px 0;\" class=\"padding-16-new m-5-new\">\n      <img style=\"width: 100%;object-fit: contain;object-position: bottom;margin-bottom:5px;\" class=\"m-5-new imageBase64\" src=\"".concat(imgBase64, "\">\n      <div style=\"width: 100%;text-align: center;font-size: 12px;\" class=\"f-16\">").concat(title, "</div>\n      </div>\n      ");
    };
    Temp1MoneyOut.prototype.commonAmountCalculationFormatForFooter = function (title, value) {
    ...
    Temp1MoneyOut.prototype.commonAmountCalculationFormatForFooterForMoneyIn = function (title, value) {
        return "\n      <div class=\"flex\" style=\"display:flex;flex-wrap:wrap;justify-content:flex-start;width:100%;\">\n      <div style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left; font-weight:bold\"\n      class=\"f-14 m-5-new\">\n        ".concat(title, "\n      </div>\n      <div\n      style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left;text-align: right;\"\n      class=\"f-14 m-5-new\">\n         ").concat(value, "\n      </div>\n      </div>\n      ");
    };
    Temp1MoneyOut.prototype.commonLeftSideFormatForPartyDetails = function (text) {
        return "\n      <div style=\"display: flow-root;font-size: 14px;color: #000;\" class=\"f-14 m-5-new\">\n          ".concat(text, " \n      </div>");
    };
    Temp1MoneyOut.prototype.commonRightSideFormatForPartyDetails = function (title, value) {
        return "\n      <div class=\"flex\" style=\"display:flex;flex-wrap:wrap;justify-content:flex-start;width:100%;\">\n      <div\n      style=\"display: flow-root;font-weight: bold;font-size: 14px;color: #000;width: 50%;float: left;\"\n      class=\"f-14 f-b\">\n        ".concat(title, " :\n      </div>\n\n      <div\n      style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left;text-align: right;\"\n      class=\"f-14\">\n         ").concat(value, "\n      </div></div>");
    };
    Temp1MoneyOut.prototype.commonDateFormat = function (dateName, timeStamp) {
        return "\n        <div\n          style=\"display: flow-root;font-weight: bold;font-size: 14px;color: #000;width: 50%;float: left;\"\n          class=\"f-14 f-b m-5-new\">\n            ".concat(dateName, " :\n          </div>\n\n          <div\n          style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left;text-align: right;\"\n          class=\"f-14 m-5-new\">\n             ").concat(commonTempData_1.commonTempData.dateToDDMMYYY(timeStamp), "\n        </div>\n      ");
    };
    Temp1MoneyOut.prototype.commonDateTimeFormat = function (dateName, timeStamp) {
        return "\n        <div\n          style=\"display: flow-root;font-weight: bold;font-size: 14px;color: #000;width: 50%;float: left;\"\n          class=\"f-14 f-b m-5-new\">\n            ".concat(dateName, " :\n          </div>\n\n          <div\n          style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left;text-align: right;\"\n          class=\"f-14 m-5-new\">\n             ").concat(commonTempData_1.commonTempData.dateToDDMMYYYHHMMAP(timeStamp), "\n        </div>\n      ");
    };
    return Temp1MoneyOut;
}());
exports.Temp1MoneyOut = Temp1MoneyOut;
//# sourceMappingURL=temp1-money-out.js.map