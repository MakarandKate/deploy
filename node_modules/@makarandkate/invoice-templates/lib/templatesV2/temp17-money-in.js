...
exports.Temp17MoneyIn = void 0;
var commonTempData_1 = require("./commonTempData");
var Temp17MoneyIn = /** @class */ (function () {
    function Temp17MoneyIn(data) {
        this.data = data;
        this.totalSaving = 0;
    }
    Temp17MoneyIn.prototype.main = function () {
    ...
    Temp17MoneyIn.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle());
    };
    Temp17MoneyIn.prototype.footer = function () {
    ...
    Temp17MoneyIn.prototype.templateBody = function () {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return __awaiter(this, void 0, void 0, function () {
            var html, modeOfPayment, txnNo, qrCodeBase64;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        html = '';
                        html += "\n          \n          <div class=\"col-xs-12\" style=\"text-align:center\">\n          <hr/>\n            <b  class=\"text-3i-h2\">\n              Received : ".concat(commonTempData_1.commonTempData.unitAdjuster((_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a.bill) === null || _b === void 0 ? void 0 : _b.totalAmount), "\n            </b>\n          <hr/>\n          </div>\n          \n          ");
                        html += "\n        <div class=\"row\">\n        </div>\n        <div class=\"row\">\n          <hr/>\n          <div class=\"col-xs-12 text-3i-h3\" style=\"text-align:right\">\n          </div>\n          ";
                        modeOfPayment = ((_d = (_c = this.data) === null || _c === void 0 ? void 0 : _c.bill) === null || _d === void 0 ? void 0 : _d.txnMode) || '';
                        txnNo = ((_f = (_e = this.data) === null || _e === void 0 ? void 0 : _e.bill) === null || _f === void 0 ? void 0 : _f.txnRef) || '';
                        if (modeOfPayment) {
                        ...
                        html += "\n        </div>\n        <div class=\"row\">\n          <hr/>\n        </div>\n      ";
                        if (!((_g = this.data) === null || _g === void 0 ? void 0 : _g.qrPayLink)) return [3 /*break*/, 2];
                        return [4 /*yield*/, commonTempData_1.commonTempData.generateQR((_h = this.data) === null || _h === void 0 ? void 0 : _h.qrPayLink)];
                    case 1:
                        qrCodeBase64 = _j.sent();
    ...
    Temp17MoneyIn.prototype.commonTwoRowDetails = function (title, value) {
        return "\n          <div class=\"col-xs-9\" style=\"text-align:right\">".concat(title, "</div>\n          <div class=\"col-xs-3\" style=\"text-align:right\">").concat(value, "</div>\n      ");
    };
    Temp17MoneyIn.prototype.commonTaxAndAmtDetails = function (title, value) {
    ...
    Temp17MoneyIn.prototype.sellerDetails = function () {
    ...
    Temp17MoneyIn.prototype.invoiceTitle = function () {
        ...
        var html = "\n        <div class=\"row\">\n          <hr/>\n          <div class=\"col-xs-12 text-3i-h2\">\n           <b>Receipt No</b>: ".concat(((_j = (_h = this.data) === null || _h === void 0 ? void 0 : _h.bill) === null || _j === void 0 ? void 0 : _j.billNo) || '', "\n          </div>\n          <div class=\"col-xs-12 text-3i-h2\">\n            \n            <b>Created On</b>: ").concat(((_l = (_k = this.data) === null || _k === void 0 ? void 0 : _k.bill) === null || _l === void 0 ? void 0 : _l.createdStamp) ? commonTempData_1.commonTempData.dateToDDMMYYYHHMMAP((_o = (_m = this.data) === null || _m === void 0 ? void 0 : _m.bill) === null || _o === void 0 ? void 0 : _o.createdStamp) : '', "\n            ").concat(isBillDateDiff ? "\n            <br/><b> Date</b>: ".concat(commonTempData_1.commonTempData.dateToDDMMYY((_q = (_p = this.data) === null || _p === void 0 ? void 0 : _p.bill) === null || _q === void 0 ? void 0 : _q.billDateStamp), "\n            ") : '', "\n          </div>\n          ").concat(((_s = (_r = this.data) === null || _r === void 0 ? void 0 : _r.settings) === null || _s === void 0 ? void 0 : _s.iSetPrintTimeOnBill) ? "\n          <div class=\"row text-3i-p\">\n             \n          </div>\n          " : '', "\n        </div>\n        \n        <div class=\"row\">\n          <hr/>\n          <div class=\"col-xs-12 text-3i-h2\">\n            <b>Received From</b> : ").concat(party === null || party === void 0 ? void 0 : party.contactPersonName).concat((party === null || party === void 0 ? void 0 : party.contactPersonPhone) ? ' <hr/> ' + (party === null || party === void 0 ? void 0 : party.contactPersonPhone) : '', "\n            ").concat(((_u = (_t = this.data) === null || _t === void 0 ? void 0 : _t.bill) === null || _u === void 0 ? void 0 : _u.isPartyDeleted) ? "<hr/><p class='text-danger'>Party Has Been Deleted</p>" : "", "\n            ").concat((party === null || party === void 0 ? void 0 : party.gstNumber) ? "<hr/>" + (party === null || party === void 0 ? void 0 : party.gstNumber) + "<hr/>" : '', "\n          </div>\n          \n          ");
    ...
    Temp17MoneyIn.prototype.commonDateFormat = function (dateName, timeStamp) {
    ...
    Temp17MoneyIn.prototype.commonDateFormat2 = function (dateName, timeStamp) {
        return "\n        <div\n          style=\"display: flow-root;font-weight: bold;color: #000;width: 50%;float: left;\"\n          class=\"f-14 f-b m-5 text-3i-h2\">\n            ".concat(dateName, " :\n          </div>\n\n          <div\n          style=\"display: flow-root;color: #000;width: 50%;float: left;text-align: right;\"\n          class=\"f-14 m-5 text-3i-h2\">\n             ").concat(commonTempData_1.commonTempData.dateToDDMMYY(timeStamp), "\n        </div>\n      ");
    };
    return Temp17MoneyIn;
}());
exports.Temp17MoneyIn = Temp17MoneyIn;
//# sourceMappingURL=temp17-money-in.js.map