...
exports.Temp19Estimate = void 0;
var ReferenceData_1 = require("../utils/ReferenceData");
var commonTempData_1 = require("./commonTempData");
var Temp19Estimate = /** @class */ (function () {
    function Temp19Estimate(data) {
        this.data = data;
        this.totalSaving = 0;
    ...
    Temp19Estimate.prototype.main = function () {
    ...
    Temp19Estimate.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle());
    };
    Temp19Estimate.prototype.footer = function () {
    ...
    Temp19Estimate.prototype.templateBody = function () {
    ...
    Temp19Estimate.prototype.commonTwoRowDetails = function (title, value) {
        return "\n          <div class=\"col-xs-9\" style=\"text-align:right\">".concat(title, "</div>\n          <div class=\"col-xs-3\" style=\"text-align:right\">").concat(value, "</div>\n      ");
    };
    Temp19Estimate.prototype.commonTaxAndAmtDetails = function (title, value) {
    ...
    Temp19Estimate.prototype.itemRow = function (invoiceItem) {
    ...
    Temp19Estimate.prototype.sellerDetails = function () {
    ...
    Temp19Estimate.prototype.invoiceTitle = function () {
    ...
    Temp19Estimate.prototype.commonDateFormat = function (dateName, timeStamp) {
    ...
    return Temp19Estimate;
}());
exports.Temp19Estimate = Temp19Estimate;
//# sourceMappingURL=temp19-estimate.js.map