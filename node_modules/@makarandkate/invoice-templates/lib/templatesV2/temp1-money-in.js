...
exports.Temp1MoneyIn = void 0;
var commonTempData_1 = require("./commonTempData");
var Temp1MoneyIn = /** @class */ (function () {
    function Temp1MoneyIn(data) {
        this.data = data;
    }
    Temp1MoneyIn.prototype.main = function () {
    ...
    Temp1MoneyIn.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle(), "\n        ").concat(this.partyDetails(), " \n      ");
    };
    Temp1MoneyIn.prototype.footer = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Temp1MoneyIn.prototype.sellerDetails = function () {
    ...
    Temp1MoneyIn.prototype.templateBody = function () {
        var html = '';
    ...
    Temp1MoneyIn.prototype.invoiceTitle = function () {
        var _a, _b, _c, _d;
        var html = '';
    ...
    Temp1MoneyIn.prototype.partyDetails = function () {
    ...
    Temp1MoneyIn.prototype.footerCalculationForMoneyIn = function () {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        var html = '';
        ...
        html += this.commonAmountCalculationFormatForFooterForMoneyIn('Mode:', (_d = (_c = this.data) === null || _c === void 0 ? void 0 : _c.bill) === null || _d === void 0 ? void 0 : _d.txnMode);
        if ((_f = (_e = this.data) === null || _e === void 0 ? void 0 : _e.bill) === null || _f === void 0 ? void 0 : _f.txnRef) {
            html += this.commonAmountCalculationFormatForFooterForMoneyIn('Cheque No:', (_h = (_g = this.data) === null || _g === void 0 ? void 0 : _g.bill) === null || _h === void 0 ? void 0 : _h.txnRef);
        }
        html += "</div>";
        //closing main div
        html += "</div>";
    ...
    Temp1MoneyIn.prototype.footerBankDetails = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    Temp1MoneyIn.prototype.footerTNCAndNotes = function () {
        var _a, _b, _c, _d;
    ...
    Temp1MoneyIn.prototype.commmonTNCAndNotesFormat = function (title, value, sectionClassName) {
    ...
    Temp1MoneyIn.prototype.commonBankDetailsFormatForFooter = function (text) {
        return " <div style=\"font-size: 12px;width: 100%;\" class=\"f-16\">".concat(text, "</div>");
    };
    Temp1MoneyIn.prototype.commonSignatureFormatForFooter = function (imgBase64, title) {
    ...
    Temp1MoneyIn.prototype.commonAmountCalculationFormatForFooter = function (title, value) {
    ...
    Temp1MoneyIn.prototype.commonAmountCalculationFormatForFooterForMoneyIn = function (title, value) {
        return "\n      <div class=\"flex\" style=\"display:flex;flex-wrap:wrap;justify-content:flex-start;width:100%;\">\n      <div style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left; font-weight:bold\"\n      class=\"f-14 m-5-new\">\n        ".concat(title, "\n      </div>\n      <div\n      style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left;text-align: right;\"\n      class=\"f-14 m-5-new\">\n         ").concat(value, "\n      </div>\n      </div>\n      ");
    };
    Temp1MoneyIn.prototype.commonLeftSideFormatForPartyDetails = function (text) {
        return "\n      <div style=\"display: flow-root;font-size: 14px;color: #000;\" class=\"f-14 m-5-new\">\n          ".concat(text, " \n      </div>");
    };
    Temp1MoneyIn.prototype.commonRightSideFormatForPartyDetails = function (title, value) {
        return "\n      <div class=\"flex\" style=\"display:flex;flex-wrap:wrap;justify-content:flex-start;width:100%;\">\n      <div\n      style=\"display: flow-root;font-weight: bold;font-size: 14px;color: #000;width: 50%;float: left;\"\n      class=\"f-14 f-b\">\n        ".concat(title, " :\n      </div>\n\n      <div\n      style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left;text-align: right;\"\n      class=\"f-14\">\n         ").concat(value, "\n      </div></div>");
    };
    Temp1MoneyIn.prototype.commonDateFormat = function (dateName, timeStamp) {
        return "\n        <div\n          style=\"display: flow-root;font-weight: bold;font-size: 14px;color: #000;width: 50%;float: left;\"\n          class=\"f-14 f-b m-5-new\">\n            ".concat(dateName, " :\n          </div>\n\n          <div\n          style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left;text-align: right;\"\n          class=\"f-14 m-5-new\">\n             ").concat(commonTempData_1.commonTempData.dateToDDMMYYY(timeStamp), "\n        </div>\n      ");
    };
    Temp1MoneyIn.prototype.commonDateTimeFormat = function (dateName, timeStamp) {
        return "\n        <div\n          style=\"display: flow-root;font-weight: bold;font-size: 14px;color: #000;width: 50%;float: left;\"\n          class=\"f-14 f-b m-5-new\">\n            ".concat(dateName, " :\n          </div>\n\n          <div\n          style=\"display: flow-root;font-size: 14px;color: #000;width: 50%;float: left;text-align: right;\"\n          class=\"f-14 m-5-new\">\n             ").concat(commonTempData_1.commonTempData.dateToDDMMYYYHHMMAP(timeStamp), "\n        </div>\n      ");
    };
    return Temp1MoneyIn;
}());
exports.Temp1MoneyIn = Temp1MoneyIn;
//# sourceMappingURL=temp1-money-in.js.map