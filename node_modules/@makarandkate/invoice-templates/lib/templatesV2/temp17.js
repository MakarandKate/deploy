...
var Temp17 = /** @class */ (function () {
    ...
    Temp17.prototype.main = function () {
    ...
    Temp17.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle());
    };
    Temp17.prototype.footer = function () {
    ...
    Temp17.prototype.templateBody = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var html, totalQty, receivedOrPaidAmt, totalTax, isTax, totalTaxAmt, sameState, partyInfo, secondaryPartyInfo, stateCode, profileStateCod, userState, partyState, secondaryStateCode, i, invoiceItem, htmlHeader, serviceChargeStr, profileStateCode, additionalAmount, receivedOrPaid, modeOfPayment, txnNo, balanceAmt, qrCodeBase64;
            return __generator(this, function (_101) {
                switch (_101.label) {
                    case 0:
                        html = '';
                        totalQty = 0;
                        ...
                        txnNo = ((_90 = (_89 = (_88 = this.data) === null || _88 === void 0 ? void 0 : _88.bill) === null || _89 === void 0 ? void 0 : _89.moneyIn) === null || _90 === void 0 ? void 0 : _90.txnRef) || '';
                        ...
                        balanceAmt = ((((_92 = (_91 = this.data) === null || _91 === void 0 ? void 0 : _91.bill) === null || _92 === void 0 ? void 0 : _92.totalAmount) || 0) - receivedOrPaidAmt);
                        if (balanceAmt > 0.01) {
                            html += this.commonTwoRowDetails('Balance', commonTempData_1.commonTempData.unitAdjuster(balanceAmt));
                        }
                        if (((_93 = this.data) === null || _93 === void 0 ? void 0 : _93.bill.partyPreviousBalance) > 0 && ((_95 = (_94 = this.data) === null || _94 === void 0 ? void 0 : _94.bill) === null || _95 === void 0 ? void 0 : _95.billCompleteStamp)) {
                            html += this.commonTwoRowDetails('Previous Balance', commonTempData_1.commonTempData.unitAdjuster((_96 = this.data) === null || _96 === void 0 ? void 0 : _96.bill.partyPreviousBalance));
                            html += "<p class=\"text-3i-h3\" style=\"text-align:right\">as on ".concat(commonTempData_1.commonTempData.dateToDDMMYY((_98 = (_97 = this.data) === null || _97 === void 0 ? void 0 : _97.bill) === null || _98 === void 0 ? void 0 : _98.billCompleteStamp), "</p>");
                        }
                        ...
                        html += "\n        </div>\n        <div class=\"row\">\n          <hr/>\n        </div>\n      ";
                        if (!((_99 = this.data) === null || _99 === void 0 ? void 0 : _99.qrPayLink)) return [3 /*break*/, 2];
                        return [4 /*yield*/, commonTempData_1.commonTempData.generateQR((_100 = this.data) === null || _100 === void 0 ? void 0 : _100.qrPayLink)];
                    case 1:
                        qrCodeBase64 = _101.sent();
    ...
    Temp17.prototype.commonTwoRowDetails = function (title, value) {
        return "\n          <div class=\"col-xs-9\" style=\"text-align:right\">".concat(title, "</div>\n          <div class=\"col-xs-3\" style=\"text-align:right\">").concat(value, "</div>\n      ");
    };
    Temp17.prototype.commonTaxAndAmtDetails = function (title, value) {
    ...
    Temp17.prototype.itemRow = function (invoiceItem) {
    ...
    Temp17.prototype.sellerDetails = function () {
    ...
    Temp17.prototype.invoiceTitle = function () {
    ...
    Temp17.prototype.commonDateFormat = function (dateName, timeStamp) {
    ...
    Temp17.prototype.commonDateFormat2 = function (dateName, timeStamp) {
        return "\n        <div\n          style=\"display: flow-root;font-weight: bold;color: #000;width: 50%;float: left;\"\n          class=\"f-14 f-b m-5 text-3i-h2\">\n            ".concat(dateName, " :\n          </div>\n\n          <div\n          style=\"display: flow-root;color: #000;width: 50%;float: left;text-align: right;\"\n          class=\"f-14 m-5 text-3i-h2\">\n             ").concat(commonTempData_1.commonTempData.dateToDDMMYY(timeStamp), "\n        </div>\n      ");
    };
    return Temp17;
}());
exports.Temp17 = Temp17;
//# sourceMappingURL=temp17.js.map