...
exports.Temp20MoneyIn = void 0;
var commonTempData_1 = require("./commonTempData");
var Temp20MoneyIn = /** @class */ (function () {
    function Temp20MoneyIn(data) {
        this.data = data;
        this.totalSaving = 0;
    }
    Temp20MoneyIn.prototype.main = function () {
    ...
    Temp20MoneyIn.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle());
    };
    Temp20MoneyIn.prototype.footer = function () {
    ...
    Temp20MoneyIn.prototype.templateBody = function () {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        return __awaiter(this, void 0, void 0, function () {
            var html, modeOfPayment, qrCodeBase64;
                ...
                switch (_l.label) {
                    case 0:
                        ...
                        if ((_f = (_e = this.data) === null || _e === void 0 ? void 0 : _e.bill) === null || _f === void 0 ? void 0 : _f.txnRef) {
                            html += "<div class=\"col-xs-12 text-3i-h3\" style=\"text-align:right\">Txn No : ".concat((_h = (_g = this.data) === null || _g === void 0 ? void 0 : _g.bill) === null || _h === void 0 ? void 0 : _h.txnRef, "</div>");
                        }
                        if (!((_j = this.data) === null || _j === void 0 ? void 0 : _j.qrPayLink)) return [3 /*break*/, 2];
                        return [4 /*yield*/, commonTempData_1.commonTempData.generateQR((_k = this.data) === null || _k === void 0 ? void 0 : _k.qrPayLink)];
                    case 1:
                        qrCodeBase64 = _l.sent();
    ...
    Temp20MoneyIn.prototype.invoiceTitle = function () {
    ...
    Temp20MoneyIn.prototype.commonDateFormat = function (dateName, timeStamp) {
    ...
    return Temp20MoneyIn;
}());
exports.Temp20MoneyIn = Temp20MoneyIn;
//# sourceMappingURL=temp20-money-in.js.map