...
exports.Temp17Expense = void 0;
var commonTempData_1 = require("./commonTempData");
var Temp17Expense = /** @class */ (function () {
    function Temp17Expense(data) {
        this.data = data;
        this.totalSaving = 0;
    }
    Temp17Expense.prototype.main = function () {
    ...
    Temp17Expense.prototype.header = function () {
        return "\n        ".concat(this.sellerDetails(), "\n        ").concat(this.invoiceTitle());
    };
    Temp17Expense.prototype.footer = function () {
    ...
    Temp17Expense.prototype.templateBody = function () {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3;
        return __awaiter(this, void 0, void 0, function () {
            var html, PaidAmt, paid, modeOfPayment, txnNo, balanceAmt, qrCodeBase64;
            return __generator(this, function (_4) {
                switch (_4.label) {
                    case 0:
                        html = '';
                        PaidAmt = 0;
                        if ((_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a.bill) === null || _b === void 0 ? void 0 : _b.moneyOut) {
                            PaidAmt = (((_e = (_d = (_c = this.data) === null || _c === void 0 ? void 0 : _c.bill) === null || _d === void 0 ? void 0 : _d.moneyOut) === null || _e === void 0 ? void 0 : _e.amount) || 0);
                        }
                        if ((_g = (_f = this.data) === null || _f === void 0 ? void 0 : _f.bill) === null || _g === void 0 ? void 0 : _g.roundOffValue) {
                            html += this.commonTaxAndAmtDetails('Round off', commonTempData_1.commonTempData.unitAdjuster((_j = (_h = this.data) === null || _h === void 0 ? void 0 : _h.bill) === null || _j === void 0 ? void 0 : _j.roundOffValue));
                        }
                        html += "\n          \n          <div class=\"col-xs-12\" style=\"text-align:center\">\n          <hr/>\n            <b  class=\"text-3i-h2\">\n              Total : ".concat(commonTempData_1.commonTempData.unitAdjuster((_l = (_k = this.data) === null || _k === void 0 ? void 0 : _k.bill) === null || _l === void 0 ? void 0 : _l.totalAmount), "\n            </b>\n          <hr/>\n          </div>\n          \n          ");
                        html += "\n        <div class=\"row\">\n          <hr/>\n          <div class=\"text-3i-h3\">\n          <b>Category</b> : ".concat((_m = this.data) === null || _m === void 0 ? void 0 : _m.category, "\n          </div>\n        </div>\n        <div class=\"row\">\n          <hr/>\n          <div class=\"col-xs-12 text-3i-h3\" style=\"text-align:right\">\n          </div>\n          ");
                        paid = 'Amount Paid';
                        modeOfPayment = ((_q = (_p = (_o = this.data) === null || _o === void 0 ? void 0 : _o.bill) === null || _p === void 0 ? void 0 : _p.moneyOut) === null || _q === void 0 ? void 0 : _q.txnMode) || '';
                        txnNo = ((_t = (_s = (_r = this.data) === null || _r === void 0 ? void 0 : _r.bill) === null || _s === void 0 ? void 0 : _s.moneyOut) === null || _t === void 0 ? void 0 : _t.txnRef) || '';
                        if (PaidAmt) {
                            html += this.commonTwoRowDetails(paid, commonTempData_1.commonTempData.unitAdjuster(PaidAmt || 0));
                            if (modeOfPayment) {
                                html += "<div class=\"col-xs-9 text-3i-h3\" style=\"text-align:right\">Mode</div><div class=\"col-xs-3 text-3i-h3\" style=\"text-align:right\">".concat(modeOfPayment, "</div>");
                                if (txnNo) {
                                    html += "<div class=\"col-xs-12 text-3i-h3\" style=\"text-align:right\">Txn No : ".concat(txnNo, "</div>");
                                }
                            }
                        }
                        balanceAmt = ((((_v = (_u = this.data) === null || _u === void 0 ? void 0 : _u.bill) === null || _v === void 0 ? void 0 : _v.totalAmount) || 0) - PaidAmt);
                        if (balanceAmt > 0) {
                            html += this.commonTwoRowDetails('Balance', commonTempData_1.commonTempData.unitAdjuster(balanceAmt));
                        }
                        if (((_w = this.data) === null || _w === void 0 ? void 0 : _w.bill.partyPreviousBalance) > 0 && ((_y = (_x = this.data) === null || _x === void 0 ? void 0 : _x.bill) === null || _y === void 0 ? void 0 : _y.billCompleteStamp)) {
                            html += this.commonTwoRowDetails('Previous Balance', commonTempData_1.commonTempData.unitAdjuster((_z = this.data) === null || _z === void 0 ? void 0 : _z.bill.partyPreviousBalance));
                            html += "<p class=\"text-3i-h3\" style=\"text-align:right\">as on ".concat(commonTempData_1.commonTempData.dateToDDMMYY((_1 = (_0 = this.data) === null || _0 === void 0 ? void 0 : _0.bill) === null || _1 === void 0 ? void 0 : _1.billCompleteStamp), "</p>");
                        }
                        ...
                        html += "\n        </div>\n        <div class=\"row\">\n          <hr/>\n        </div>\n      ";
                        if (!((_2 = this.data) === null || _2 === void 0 ? void 0 : _2.qrPayLink)) return [3 /*break*/, 2];
                        return [4 /*yield*/, commonTempData_1.commonTempData.generateQR((_3 = this.data) === null || _3 === void 0 ? void 0 : _3.qrPayLink)];
                    case 1:
                        qrCodeBase64 = _4.sent();
    ...
    Temp17Expense.prototype.commonTwoRowDetails = function (title, value) {
        return "\n          <div class=\"col-xs-9\" style=\"text-align:right\">".concat(title, "</div>\n          <div class=\"col-xs-3\" style=\"text-align:right\">").concat(value, "</div>\n      ");
    };
    Temp17Expense.prototype.commonTaxAndAmtDetails = function (title, value) {
    ...
    Temp17Expense.prototype.sellerDetails = function () {
    ...
    Temp17Expense.prototype.invoiceTitle = function () {
    ...
    Temp17Expense.prototype.commonDateFormat = function (dateName, timeStamp) {
    ...
    Temp17Expense.prototype.commonDateFormat2 = function (dateName, timeStamp) {
        return "\n        <div\n          style=\"display: flow-root;font-weight: bold;color: #000;width: 50%;float: left;\"\n          class=\"f-14 f-b m-5 text-3i-h2\">\n            ".concat(dateName, " :\n          </div>\n\n          <div\n          style=\"display: flow-root;color: #000;width: 50%;float: left;text-align: right;\"\n          class=\"f-14 m-5 text-3i-h2\">\n             ").concat(commonTempData_1.commonTempData.dateToDDMMYY(timeStamp), "\n        </div>\n      ");
    };
    return Temp17Expense;
}());
exports.Temp17Expense = Temp17Expense;
//# sourceMappingURL=temp17-expense.js.map