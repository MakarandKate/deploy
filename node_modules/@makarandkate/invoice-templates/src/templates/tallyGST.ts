...
export class TallyGST{
    ...
    async main(){
      ...
      <span class="invoice-template-main">
        <div 
          ...
          style="display:flow-root;width:${this.data.pageWidth || 210}mm;background: white;padding: 0;padding-bottom: 70px;visibility: visible;-webkit-print-color-adjust: exact !important;color-adjust: exact !important;">
    ...
    commonSignatureFormatForFooter(imgBase64, title){
      ...
      <div class="padding-10-new" style="display: flex;width: 20%;padding:0 5px;flex-wrap: wrap;align-items: flex-end;">
        <img src="${imgBase64}" style="width: 100%;height: auto;margin:auto;">
    ...
    hsnSacTable(){
      ...
      html +=`
        ...
        <td class="font-10 padding-5555" colspan="2"
          style="text-transform:uppercase;color:#000;text-align: center;font-weight: normal;padding:0 2px;border-bottom:0;border-top:0;border-right:0;">
        ...
        html +=`<td class="font-12 padding-5555" rowspan="2"
          style="text-transform:uppercase;color:#000;text-align: center;padding:0 2px;border-top:0;border-right:0;">
          Total Tax</td>
        </tr>
        <tr>
    ...
    invoiceTitle(){
      ...
      //S: div1
      html+=`<div class="inv-title-holder" style="display: flex;margin: 0 15px 15px 15px;margin-bottom: 0 !important;">`;
    ...
    sellerAndPartyAndTemplateBody(){
      ...
      if(sellerProfileData?.addressLine1 || sellerProfileData?.addressState){
        html += this.commonLeftSideOfSellerDetails(`${sellerProfileData?.addressLine1}${sellerProfileData?.addressState?', '+sellerProfileData?.addressState:''}${sellerProfileData?.addressPincode?', '+sellerProfileData?.addressPincode:''}`);
      }
      ...
      if(this.data?.user?.profileData?.gstNumber){
        html+= `
        <div class="f-14" style="font-size: 14px;color:#000;font-weight:bold">${this.data?.user?.profileData?.gstNumber}</div>
        `
      }
      if(
        ...
        && ((this.data?.user?.profileData?.additionalDateFieldValue + "").trim()).length>0
          ...
          html += `<div class="f-14" style="font-size: 14px;width: 100%;color:#000;"><b>${this.data.user.profileData.additionalDateFieldTitle} : </b>${this.data.user.profileData.additionalDateFieldValue}</div>`
      }
      ...
      if(
        ...
        && ((this.data?.user?.profileData?.additionalInputFieldValue + "").trim()).length>0
          ...
          html += `<div class="f-14" style="font-size: 14px;width: 100%;color:#000;"><b>${this.data.user.profileData.additionalInputFieldTitle} : </b>${this.data.user.profileData.additionalInputFieldValue}</div>`
      }
      html+=`</div>`
      ...
      if(this.data?.isEstimate && this.data?.createdStamp){
        ...
        style="width:33.33%;padding:0 5px;display:flow-root;">
           ...
           <div class="f-14" style="width:100%;text-align: center;color:#000;font-size: 14px;font-weight:bold">${commonTempData.dateToDDMMYYYHHMMAP(this.data?.createdStamp)}</div>
         </div>    
      `
      }
      ...
      if(this.data?.challanNo && this.data?.challanNo != ' ' ){
        html += this.commonRightSideOfSellerDetails('Challan No',this.data?.challanNo);
      }
    ...
    templateBody(){
      ...
      style="background-color:#dbdaf3;border-bottom: 1px solid #000000;-webkit-print-color-adjust: exact !important;color-adjust: exact !important;color:#000;">
        <th class="f-14" style="border-left:0px;font-size:14px;color:#000;text-align: center;padding:0 2px;border-top:0;">#</th>
        ...
        <th class="f-14" style="font-size:14px;color:#000;text-align: right;padding:0 2px;border-top:0;text-transform: uppercase;word-break: break-word;${!isHsn?'display: none':''}">HSN Code</th>
        ...
        <th class="f-14" style="font-size:14px;color:#000;text-align: right;padding:0 2px;border-top:0;text-transform: uppercase;word-break: break-word;${!isAdditionlInputField?'display: none':''}">${additionlInputFieldTitle}</th>
        <th class="f-14" style="font-size:14px;color:#000;text-align: right;padding:0 2px;border-top:0;text-transform: uppercase;word-break: break-word;word-break: inherit;${!isExpiryDate?'display: none':''}">Expiry Date</th>
        <th class="f-14" style="font-size:14px;color:#000;text-align: right;padding:0 2px;border-top:0;text-transform: uppercase;word-break: break-word;word-break: inherit;${!isAdditionlDateField?'display: none':''}">${additionlDateFieldTitle}</th>
        <th class="f-14" style="font-size:14px;color:#000;text-align: right;padding:0 2px;border-top:0;text-transform: uppercase;word-break: break-word;${!isMrp?'display: none':''}">MRP</th>
        ...
        <th class="f-14" style="font-size:14px;color:#000;text-align: right;padding:0 2px;border-top:0;text-transform: uppercase;word-break: break-word;${!isDiscount?'display: none':''}">Disc</th>
        <th class="f-14" style="font-size:14px;color:#000;text-align: right;padding:0 2px;border-top:0;text-transform: uppercase;word-break: break-word;${!this.isTax?'display: none':''}">Tax Amt</th>
        <th  class="f-14" style="border-top:0;font-size:14px;color:#000;text-align: right;padding:0 2px;border-right:0;text-transform: uppercase;word-break: break-word;">Total</th>
      </thead>
      `
      ...
      for (let i = 0; i < this.data?.invoiceItems?.length; i++) {
        ...
        html += `
        <tr>
          <td class="f-14 padding-1055-new" style="font-size:14px;border-left:0px;text-align: center;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;vertical-align:top;">${i+1}</td>
          <td class="f-14 padding-1055-new"
          style="font-size:14px;text-align: left;width: 30%;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;${dynamicBoldCss}">
            ${(el.item?.itemName ||'')} ${( el?.variant ? " (" + el?.variant + ")" : "")}
            <span class="f-10" style="display: block;color: grey;font-size: 10px;">${((el?.itemDes && el.itemDes !="0")?el.itemDes:'')}</span>
            <span class="f-10" style="display: block;color: grey;font-size: 10px;">${(el?.itemSrl?'('+el?.itemSrl+')':'')}</span>
          </td>
          <td class="f-14 padding-1055-new" style="font-size:14px;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;${!isHsn?'display: none':''}">${el?.hsn || el?.item?.hsn|| ''}</td>
          <td class="f-14 padding-1055-new" style="font-size:14px;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;">${commonTempData.unitAdjuster((el?.quantity||0))+" "+(el?.unit||'')}</td>
          <td class="f-14 padding-1055-new" style="font-size:14px;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;${!isAdditionlInputField?'display: none':''}">${el?.additionalInputFieldValue||''}</td>
          <td class="f-14 padding-1055-new" style="font-size:14px;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;${!isExpiryDate?'display: none':''}">${el?.item?.expiryDate? commonTempData.dateToDDMMYYY(el?.item?.expiryDate):''}</td>
          <td class="f-14 padding-1055-new" style="font-size:14px;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;${!isAdditionlDateField?'display: none':''}">${el?.additionalDateFieldValue||''}</td>
          <td class="f-14 padding-1055-new" style="font-size:14px;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;${!isMrp?'display: none':''}">${(el?.mrp ||el?.item?.mrp)||''}</td>
          <td class="f-14 padding-1055-new" style="font-size:14px;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;">${sellOrPurchasePrice}</td>
          <td class="f-14 padding-1055-new" style="font-size:14px;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;${!isDiscount?'display: none':''}">${(el?.totalDiscount?(this.data.showTaxAndDiscAmt?((el?.totalDiscount) +'<br>'):'')+'('+discountPercent+'%'+')':'')}</td>
          <td class="f-14 padding-1055-new" style="font-size:14px;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;${!this.isTax?'display: none':''}">
          ...
          <td class="f-14 padding-1055-new" style="font-size:14px;border-right:0;vertical-align:top;text-align: right;padding:0 2px;border-right:0;border-bottom:0;border-top: 0;${dynamicBoldCss}">${el?.totalAmount}</td>
        </tr>
        `
      }
      // tbody tag closed
      ...
      if(this.data?.flatDiscountWithInvoiceDiscount){
        discountString=this.commonTemplatebody({...bodyObj,amount:this.data?.flatDiscountWithInvoiceDiscount,title:'Cash Discount'},  `(${this.data?.flatDiscountPercentage}%)`)
      }else if(this.data?.flatDiscount){
        discountString=this.commonTemplatebody({...bodyObj,amount:this.data?.flatDiscount,title:'Cash Discount'},  ``)
      }

      html +=`
      <div class="inv-total-holder-wrapper" style="margin:0 !important; padding:0 !important">
      <div style="height: 1px; width: 100%;"></div>
      ${EzoAd.showAd(this.data?.fbUser)}
      ...
      ${discountString}
        ...
        <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;border-left:0;"></th>
        ...
        <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!isHsn?'display: none':''}"></th>
        <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;">${commonTempData.unitAdjuster(totalQty)}</th>
        <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!isAdditionlInputField?'display: none':''}"></th>
        <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!isExpiryDate?'display: none':''}"></th>
        <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!isAdditionlDateField?'display: none':''}"></th>
        <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!isMrp?'display: none':''}"></th>
        ...
        <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!isDiscount?'display: none':''}">
        ${(this.data?.discountAmount?'₹'+this.data?.discountAmount:'')}
        </th>
        <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!this.isTax?'display: none':''}">
        ${((this.data?.gstAmount||0)+(totalCess))>0?'₹'+commonTempData.unitAdjuster((this.data?.gstAmount||0)+(totalCess)):''}
        </th>
        <th class="f-14 padding-5555" style="font-weight:bold;font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;">
      ...
      ${this.data?.showPreviousAmount? this.commonTemplatebody({...bodyObj,amount:(this.data?.partyData?.ledgerCredit||0),title:'Previous Balance',isBold:true}):''}

      ${
        this.data?.showPreviousAmount ? 
        (
          this.data?.isPurchase ? 
            this.commonTemplatebody({
              ...bodyObj,
              amount:((this.data?.partyData?.ledgerCredit||0) - balanceAmt),
              title:'Total Balance',
              isBold:true
            })
          :
      ...
      ${this.data?.billSavingsAmount?this.commonTemplatebody({...bodyObj,amount:this.totalSaving,title:'Total Saving',isBold:true}):''}
    ...
    commonTemplatebody(data, extraString?){
      if(!data?.amount){
        return ''
      }
      let dynamicBoldCss = '';
      ...
      <tr>
      <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;border-left:0;"></th>
      <th class="f-14 padding-5555" style="font-weight:normal;font-size:14px;color:#000000;text-align: left;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${dynamicBoldCss};width:30%;">${data?.title}</th>
      <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!data?.isHsn?'display: none':''}"></th>
      <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;"></th>
      <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!data?.isAdditionlInputField?'display: none':''}"></th>
      <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!data?.isAdditionlDateField?'display: none':''}"></th>
      <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!data?.isMrp?'display: none':''}"></th>
      <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;"></th>
      <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!data?.isDiscount?'display: none':''}"></th>
      <th class="f-14 padding-5555" style="font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${!data?.isTax?'display: none':''}"></th>
      <th class="f-14 padding-5555" style="font-weight:normal;font-size:14px;color:#000000;text-align: right;padding:0 2px;border-right:0;border-bottom:0;text-transform: uppercase;${dynamicBoldCss}">
      ₹${commonTempData?.unitAdjuster(data?.amount ||0)} ${ extraString ? extraString : "" }
      </th>
      `
    }
    ...
    partyDetails(){
      ...
      if (this.data?.partyInfo?.profileData?.additionalDateFieldTitle
        ...
        html += `<div class="f-14" style="font-size: 14px;width: 100%;color:#000;"><b>${this.data.partyInfo.profileData.additionalDateFieldTitle} : </b>${this.data.partyInfo.profileData.additionalDateFieldValue}</div>`
      }
      ...
      if (this.data?.partyInfo?.profileData?.additionalInputFieldTitle 
        ...
        html += `<div class="f-14" style="font-size: 14px;width: 100%;color:#000;"><b>${this.data.partyInfo.profileData.additionalInputFieldTitle} : </b>${this.data.partyInfo.profileData.additionalInputFieldValue}</div>`
      }
