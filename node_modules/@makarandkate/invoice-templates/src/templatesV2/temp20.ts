    ...
    async templateBody(){
      ...
      html+=`
        ...
        if(receivedOrPaidAmt){
          ...
          if(this.data?.bill?.moneyIn?.txnRef){
            html+=`<div class="col-xs-12 text-3i-h3" style="text-align:right">Txn No : ${this.data?.bill?.moneyIn?.txnRef}</div>`
          }
    ...
    invoiceTitle(){
      ...
      let html = `
        <div class="row">
          ...
          <div class="col-xs-12 text-3i-h2">
            <b>Created On</b>:<p>${this.data?.bill?.createdStamp?commonTempData.dateToDDMMYYHHMMAP(this.data?.bill?.billCompleteStamp):''}</p>
          </div>
          ${isBillDateDiff?`
            <div class="col-xs-12 text-3i-h2">
          ...
          <div class="col-xs-12 text-3i-h2">
            ${this.data?.bill?.dueDateStamp && this.data?.bill?.dueDateStamp>0 ?`<b>Due On</b>: ${commonTempData.dateToDDMMYY(this.data?.bill?.dueDateStamp)}`:''}
          </div>
        </div>
        <div class="row">
          <hr/>
          ...
          if(this.data?.bill?.secondaryPartyData?.profileData?.contactPersonName) {
            html += `
              <div class="col-xs-12 text-3i-h2">
                Bill To : ${this.data?.bill?.secondaryPartyData?.profileData?.contactPersonName}${this.data?.bill?.secondaryPartyData?.profileData?.contactPersonPhone ? ' <hr/> '+this.data?.bill?.secondaryPartyData?.profileData?.contactPersonPhone : ''}
