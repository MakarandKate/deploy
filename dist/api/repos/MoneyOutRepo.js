...
const MoneyOutDao_1 = require("../daos/MoneyOutDao");
let MoneyOutRepo = class MoneyOutRepo {
    constructor(dao) {
        this.dao = dao;
    }
    ...
    getAllBySale(phone, profileId, invoiceUUID) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.dao.getAllByPurchase(phone, profileId, invoiceUUID);
        });
    }
};
MoneyOutRepo = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [MoneyOutDao_1.MoneyOutDao])
], MoneyOutRepo);
exports.MoneyOutRepo = MoneyOutRepo;
//# sourceMappingURL=MoneyOutRepo.js.map