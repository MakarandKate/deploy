...
let ImageRepo = class ImageRepo {
    ...
    getByUUID(phone, profileId, uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            let image = yield this.dao.getByUUID(phone, profileId, uuid);
            if (image != null) {
...
ImageRepo = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [ImageDao_1.ImageDao])
], ImageRepo);
