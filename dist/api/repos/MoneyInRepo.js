...
const MoneyInDao_1 = require("../daos/MoneyInDao");
let MoneyInRepo = class MoneyInRepo {
    constructor(dao) {
        this.dao = dao;
    }
    ...
    getAllBySale(phone, profileId, invoiceUUID) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.dao.getAllBySale(phone, profileId, invoiceUUID);
        });
    }
};
MoneyInRepo = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [MoneyInDao_1.MoneyInDao])
], MoneyInRepo);
exports.MoneyInRepo = MoneyInRepo;
//# sourceMappingURL=MoneyInRepo.js.map