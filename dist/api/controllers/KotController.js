...
let KotController = class KotController {
    ...
    saveAll(req, itemCategories) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let records = yield this.kotService.saveAll(itemCategories, phone);
            (0, ablyLoader_1.broadCastMessage)(phone, {
                type: 'Kot',
            });
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Kot" } };
        });
    }
    fetchAll(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let records = yield this.kotService.fetchAll(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Kot" } };
        });
    }
    fetchAllv3(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lastSyncStamp = Number(req.body.lastSyncStamp) || 0;
            let accessProfiles = req.body.accessProfiles;
            let records = yield this.kotService.fetchAllv3(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Kot" } };
        });
    }
...
], KotController.prototype, "saveAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], KotController.prototype, "fetchAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], KotController.prototype, "fetchAllv3", null);
KotController = __decorate([
    (0, routing_controllers_1.Controller)('/kot')
    //@UseBefore(express.json({limit:'500mb'}))
    ,
    (0, routing_controllers_1.UseBefore)(Authorize_middleware_1.Authorize),
    __metadata("design:paramtypes", [KotService_1.KotService])
], KotController);
exports.KotController = KotController;
//# sourceMappingURL=KotController.js.map