...
let ItemController = class ItemController {
    ...
    saveAll(req, items, serverSyncStamp) {
        return __awaiter(this, void 0, void 0, function* () {
            let locals = req.locals;
            let phone = locals.phone;
            let records = yield this.itemService.saveAll(items, phone);
            (0, ablyLoader_1.broadCastMessage)(phone, {
                type: 'Item'
            });
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Item" } };
        });
    }
    fetchAll(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let records = yield this.itemService.fetchAll(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Item" } };
        });
    }
    fetchAllv3(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lastSyncStamp = Number(req.body.lastSyncStamp) || 0;
            let accessProfiles = req.body.accessProfiles;
            let records = yield this.itemService.fetchAllv3(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Item" } };
        });
    }
    fetchAllv4(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lastSyncStamp = Number(req.body.lastSyncStamp) || 0;
            let accessProfiles = req.body.accessProfiles;
            let records = yield this.itemService.fetchAllv4(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Item" } };
        });
    }
...
], ItemController.prototype, "saveAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ItemController.prototype, "fetchAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ItemController.prototype, "fetchAllv3", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ItemController.prototype, "fetchAllv4", null);
ItemController = __decorate([
    (0, routing_controllers_1.Controller)('/item')
