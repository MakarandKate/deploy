...
let PartyController = class PartyController {
    ...
    saveAll(req, parties) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let records = yield this.partyService.saveAll(parties, phone);
            (0, ablyLoader_1.broadCastMessage)(phone, {
                type: 'Party',
            });
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Party" } };
        });
    }
    fetchAll(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let records = yield this.partyService.fetchAll(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Party" } };
        });
    }
    fetchAllv3(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lastSyncStamp = Number(req.body.lastSyncStamp) || 0;
            let accessProfiles = req.body.accessProfiles;
            let records = yield this.partyService.fetchAllv3(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Party" } };
        });
    }
...
PartyController = __decorate([
    (0, routing_controllers_1.Controller)('/party')
