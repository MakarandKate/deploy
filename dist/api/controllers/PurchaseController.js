...
let PurchaseController = class PurchaseController {
    ...
    getAllDeleted(req, profileId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            let records = yield this.purchaseService.getAllDeleted(profileId, userId);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Purchase" } };
        });
    }
    saveAll(req, purchases) {
        return __awaiter(this, void 0, void 0, function* () {
            let locals = req.locals;
            let phone = locals.phone;
            let records = yield this.purchaseService.saveAll(purchases, phone);
    ...
    fetchAll(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let records = yield this.purchaseService.fetchAll(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Purchase" } };
        });
    }
    fetchAllv3(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lastSyncStamp = Number(req.body.lastSyncStamp) || 0;
            let accessProfiles = req.body.accessProfiles;
            let records = yield this.purchaseService.fetchAllv3(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Purchase" } };
        });
    }
    fetchAllv4(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lastSyncStamp = Number(req.body.lastSyncStamp) || 0;
            let accessProfiles = req.body.accessProfiles;
            let records = yield this.purchaseService.fetchAllv4(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Purchase" } };
        });
    }
...
], PurchaseController.prototype, "getAllDeleted", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PurchaseController.prototype, "saveAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PurchaseController.prototype, "fetchAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PurchaseController.prototype, "fetchAllv3", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PurchaseController.prototype, "fetchAllv4", null);
PurchaseController = __decorate([
    (0, routing_controllers_1.Controller)('/purchase')
