...
let ItemUnitController = class ItemUnitController {
    ...
    saveAll(req, itemCategories) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let records = yield this.itemUnitService.saveAll(itemCategories, phone);
            (0, ablyLoader_1.broadCastMessage)(phone, {
                type: 'ItemUnit',
            });
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "ItemUnit" } };
        });
    }
    fetchAll(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let records = yield this.itemUnitService.fetchAll(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "ItemUnit" } };
        });
    }
    fetchAllv3(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lastSyncStamp = Number(req.body.lastSyncStamp) || 0;
            let accessProfiles = req.body.accessProfiles;
            let records = yield this.itemUnitService.fetchAllv3(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "ItemUnit" } };
        });
    }
...
], ItemUnitController.prototype, "saveAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ItemUnitController.prototype, "fetchAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ItemUnitController.prototype, "fetchAllv3", null);
ItemUnitController = __decorate([
    (0, routing_controllers_1.Controller)('/itemUnit')
    //@UseBefore(express.json({limit:'500mb'}))
    ,
    (0, routing_controllers_1.UseBefore)(Authorize_middleware_1.Authorize),
    __metadata("design:paramtypes", [ItemUnitService_1.ItemUnitService])
], ItemUnitController);
exports.ItemUnitController = ItemUnitController;
//# sourceMappingURL=ItemUnitController.js.map