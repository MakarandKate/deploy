...
let ProfileController = class ProfileController {
    constructor(profileService, fbMigrationService) {
        this.profileService = profileService;
        this.fbMigrationService = fbMigrationService;
    }
    saveAll(req, profiles) {
        return __awaiter(this, void 0, void 0, function* () {
            let locals = req.locals;
            let phone = locals.phone;
            let records = yield this.profileService.saveAll(profiles, phone);
    ...
    fetchAll(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let records = yield this.profileService.fetchAll(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Profile" } };
        });
    }
    fetchAllv3(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lastSyncStamp = Number(req.body.lastSyncStamp) || 0;
            let accessProfiles = req.body.accessProfiles;
            let records = yield this.profileService.fetchAllv3(phone, lastSyncStamp, accessProfiles);
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Profile" } };
        });
    }
    fetchAllv3WithFB(req) {
        return __awaiter(this, void 0, void 0, function* () {
            let locals = req.locals;
            let phone = locals.phone;
            let lastSyncStamp = Number(req.body.lastSyncStamp) || 0;
            let accessProfiles = req.body.accessProfiles;
            let records = yield this.profileService.fetchAllv3(phone, lastSyncStamp, accessProfiles);
            let fbRecords = yield this.fbMigrationService.getAllProfiles(phone);
            fbRecords === null || fbRecords === void 0 ? void 0 : fbRecords.forEach(fbProfile => records.push(fbProfile));
            let st = Utils_1.default.responseDate();
            return { records, st, meta: { collection: "Profile" } };
        });
    }
...
], ProfileController.prototype, "saveAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProfileController.prototype, "fetchAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ProfileController.prototype, "fetchAllv3", null);
__decorate([
    (0, routing_controllers_1.Post)('/fetchAllv3WithFB'),
    __param(0, (0, routing_controllers_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ProfileController.prototype, "fetchAllv3WithFB", null);
ProfileController = __decorate([
    (0, routing_controllers_1.Controller)('/profile')
