...
let PurchaseDao = class PurchaseDao {
    constructor() { }
    getByUUID(phone, profileId, uuid) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let sale = PurchaseRepository_1.PurchaseRepository.findOneBy({
                    userId: phone,
                    profileId,
                    _localUUID: uuid,
                });
    ...
    getAllByProfile(phone, profileId) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let sales = yield PurchaseRepository_1.PurchaseRepository.find({
                    where: {
                        userId: phone,
                        profileId,
                        updatedStamp: {
...
PurchaseDao = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [])
], PurchaseDao);
exports.PurchaseDao = PurchaseDao;
//# sourceMappingURL=PurchaseDao.js.map