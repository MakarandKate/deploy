...
let DummyService = class DummyService extends BaseService_1.BaseService {
    constructor(eventDispatcher) {
        super(DummyRepository_1.DummyRepository);
        this.eventDispatcher = eventDispatcher;
    }
    getDeleted() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield DummyRepository_1.DummyRepository.findDeleted();
        });
    }
};
