...
let PurchaseService = class PurchaseService extends BaseService_1.BaseService {
    constructor(eventDispatcher) {
        super(PurchaseRepository_1.PurchaseRepository);
        this.eventDispatcher = eventDispatcher;
    }
    getDeleted() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PurchaseRepository_1.PurchaseRepository.findDeleted();
        });
    }
    getAllDeleted(profileId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PurchaseRepository_1.PurchaseRepository.findBy({
                deletedStamp: { $gt: 0 },
                profileId,
                userId
            });
    ...
    getByUUID(uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            return PurchaseRepository_1.PurchaseRepository.findOneBy({
                _localUUID: uuid,
            });
        });
    }
    getByOldFirebaseId(oldFirebaseId) {
        return __awaiter(this, void 0, void 0, function* () {
            return PurchaseRepository_1.PurchaseRepository.findOneBy({ oldFirebaseId });
        });
    }
    save(document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let checkDocument = yield PurchaseRepository_1.PurchaseRepository.findOne({
                where: {
            ...
            if (checkDocument != null) {
                if (checkDocument.updatedStamp < document.updatedStamp) {
                    ...
                    let updateResult = yield PurchaseRepository_1.PurchaseRepository.updateMany({
                        _localUUID: checkDocument._localUUID
                    }, {
                        "$set": Object.assign({}, document)
                    });
                    let savedDocument = yield PurchaseRepository_1.PurchaseRepository.findOne({
                        where: {
                            _localUUID: document._localUUID,
                            profileId: document.profileId
                        },
                ...
                document._is = +new Date();
                let savedDocument = yield PurchaseRepository_1.PurchaseRepository.save(document);
                savedDocument._serverIdRef = savedDocument._id.toString();
                savedDocument._localId = localId;
    ...
    saveAll(purchases, phone) {
        return __awaiter(this, void 0, void 0, function* () {
            let savedPurchases = [];
            for (let i = 0; i < (purchases === null || purchases === void 0 ? void 0 : purchases.length); i++) {
                const purchase = purchases[i];
                if (!purchase.userId) {
                    purchase.userId = phone;
                }
                savedPurchases.push(yield this.save(purchase));
            }
    ...
    fetchAll(phone, lastSyncStamp, accessProfiles) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (userIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                purchases = yield PurchaseRepository_1.PurchaseRepository.find({
            ...
            if ((accessProfiles === null || accessProfiles === void 0 ? void 0 : accessProfiles.length) > 0) {
                for (let i = 0; i < accessProfiles.length; i++) {
                    ...
                    if (profileIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                        profilePurchases = yield PurchaseRepository_1.PurchaseRepository.find({
                            where: Object.assign({ profileId, updatedStamp: {
                                    $gt: lastSyncStamp || 0
                                } }, includeDeleted)
                        });
                    }
                    if (profilePurchases && profilePurchases.length) {
                        purchases.push(...profilePurchases);
                    }
                }
            }
            let rawDocuments = purchases;
    ...
    fetchAllv4(phone, lastSyncStamp, accessProfiles) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let userIdCollectionStamp = Number(userIdCollectionStampStr) || 0;
            if (userIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                let qr = yield purchase_1.PurchaseRepo.find(Object.assign({ userId: phone, updatedStamp: {
                        $gt: lastSyncStamp || 0
                    } }, includeDeleted)).sort({
                    updatedStamp: 1
                }).limit(500);
            ...
            if ((accessProfiles === null || accessProfiles === void 0 ? void 0 : accessProfiles.length) > 0) {
                for (let i = 0; i < accessProfiles.length; i++) {
                    ...
                    let profileIdCollectionStamp = Number(profileIdCollectionStampStr) || 0;
                    if (profileIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                        let qr = yield purchase_1.PurchaseRepo.find(Object.assign({ profileId, updatedStamp: {
                                $gt: lastSyncStamp || 0
                            } }, includeDeleted)).sort({
                            updatedStamp: 1
                        }).limit(500);
    ...
    permanentDeleteAll(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield PurchaseRepository_1.PurchaseRepository.delete({
                userId
            });
        });
    }
    getAll2() {
        return __awaiter(this, void 0, void 0, function* () {
            return PurchaseRepository_1.PurchaseRepository.findBy({});
        });
    }
    getPurchaseReport(phone, lastSyncStamp) {
        return __awaiter(this, void 0, void 0, function* () {
            let rawDocuments = yield PurchaseRepository_1.PurchaseRepository.find({
                where: {
                    userId: phone,
                    updatedStamp: {
                        $gt: lastSyncStamp || 0
