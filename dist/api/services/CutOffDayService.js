...
exports.CutOffDayService = void 0;
const BaseService_1 = require("./BaseService");
const typedi_1 = require("typedi");
const EventDispatcher_1 = require("../../decorators/EventDispatcher");
const Utils_1 = __importDefault(require("../../lib/Utils"));
const RedisApp_1 = require("../../lib/RedisApp");
const CutOffDayRepository_1 = require("../repositories/CutOffDayRepository");
let CutOffDayService = class CutOffDayService extends BaseService_1.BaseService {
    constructor(eventDispatcher) {
        super(CutOffDayRepository_1.CutOffDayRepository);
        this.eventDispatcher = eventDispatcher;
    }
    getDeleted() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield CutOffDayRepository_1.CutOffDayRepository.findDeleted();
        });
    }
    getByUUID(uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            return CutOffDayRepository_1.CutOffDayRepository.findOneBy({
                _localUUID: uuid,
            });
        });
    }
    save(document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let checkDocument = yield CutOffDayRepository_1.CutOffDayRepository.findOne({
                where: {
            ...
            if (checkDocument != null) {
                if (checkDocument.updatedStamp < document.updatedStamp) {
                    ...
                    let updateResult = yield CutOffDayRepository_1.CutOffDayRepository.updateMany({
                        _localUUID: checkDocument._localUUID
                    }, {
                        "$set": Object.assign({}, document)
                    });
                    let savedDocument = yield CutOffDayRepository_1.CutOffDayRepository.findOne({
                        where: {
                            _localUUID: document._localUUID,
                            profileId: document.profileId
                        },
                ...
                document._is = +new Date();
                let savedDocument = yield CutOffDayRepository_1.CutOffDayRepository.save(document);
                savedDocument._serverIdRef = savedDocument._id.toString();
                savedDocument._localId = localId;
    ...
    saveAll(documents, phone) {
        return __awaiter(this, void 0, void 0, function* () {
            let savedDocuments = [];
            for (let i = 0; i < (documents === null || documents === void 0 ? void 0 : documents.length); i++) {
                const document = documents[i];
                if (!document.userId) {
                    document.userId = phone;
                }
                savedDocuments.push(yield this.save(document));
            }
    ...
    fetchAll(phone, lastSyncStamp, accessProfiles) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (userIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                parties = yield CutOffDayRepository_1.CutOffDayRepository.find({
            ...
            if ((accessProfiles === null || accessProfiles === void 0 ? void 0 : accessProfiles.length) > 0) {
                for (let i = 0; i < accessProfiles.length; i++) {
                    ...
                    if (profileIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                        profileDocuments = yield CutOffDayRepository_1.CutOffDayRepository.find({
    ...
    fetchAllv3(phone, lastSyncStamp, accessProfiles) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let userIdCollectionStamp = Number(userIdCollectionStampStr) || 0;
            if (userIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                documents = yield CutOffDayRepository_1.CutOffDayRepository.find({
                    where: Object.assign({ userId: phone, updatedStamp: {
                            $gt: lastSyncStamp || 0
                        } }, includeDeleted),
                    order: {
    ...
    permanentDeleteAll(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield CutOffDayRepository_1.CutOffDayRepository.delete({
                userId
            });
        });
    }
};
CutOffDayService = __decorate([
    (0, typedi_1.Service)(),
    __param(0, (0, EventDispatcher_1.EventDispatcher)()),
    __metadata("design:paramtypes", [EventDispatcher_1.EventDispatcherInterface])
], CutOffDayService);
exports.CutOffDayService = CutOffDayService;
//# sourceMappingURL=CutOffDayService.js.map