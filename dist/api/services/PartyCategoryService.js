...
exports.PartyCategoryService = void 0;
...
let PartyCategoryService = class PartyCategoryService extends BaseService_1.BaseService {
    constructor(eventDispatcher) {
        super(PartyCategoryRepository_1.PartyCategoryRepository);
        this.eventDispatcher = eventDispatcher;
    }
    getDeleted() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PartyCategoryRepository_1.PartyCategoryRepository.findDeleted();
        });
    }
    save(document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let checkDocument = yield PartyCategoryRepository_1.PartyCategoryRepository.findOne({
                where: {
            ...
            if (checkDocument != null) {
                if (checkDocument.updatedStamp < document.updatedStamp) {
                    ...
                    let updateResult = yield PartyCategoryRepository_1.PartyCategoryRepository.updateMany({
                        _localUUID: checkDocument._localUUID
                    }, {
                        "$set": Object.assign({}, document)
                    });
                    let savedDocument = yield PartyCategoryRepository_1.PartyCategoryRepository.findOne({
                        where: {
                            _localUUID: document._localUUID,
                            profileId: document.profileId
                        },
                ...
                document._is = +new Date();
                let savedDocument = yield PartyCategoryRepository_1.PartyCategoryRepository.save(document);
                savedDocument._serverIdRef = savedDocument._id.toString();
                savedDocument._localId = localId;
            ...
            try {
                let collectionName = 'PartyCategory';
    ...
    saveAll(partyCategories, phone) {
        return __awaiter(this, void 0, void 0, function* () {
            let savedPartyCategorys = [];
            for (let i = 0; i < (partyCategories === null || partyCategories === void 0 ? void 0 : partyCategories.length); i++) {
                const partyCategory = partyCategories[i];
                if (!partyCategory.userId) {
                    partyCategory.userId = phone;
                }
                savedPartyCategorys.push(yield this.save(partyCategory));
            }
            return savedPartyCategorys;
        });
    }
    fetchAll(phone, lastSyncStamp, accessProfiles) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (userIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                partyCategories = yield PartyCategoryRepository_1.PartyCategoryRepository.find({
                    where: Object.assign({ userId: phone, updatedStamp: {
                            $gt: lastSyncStamp || 0
                        } }, includeDeleted)
                });
            }
            if (partyCategories == null) {
                partyCategories = [];
            }
            if ((accessProfiles === null || accessProfiles === void 0 ? void 0 : accessProfiles.length) > 0) {
                for (let i = 0; i < accessProfiles.length; i++) {
                    ...
                    if (profileIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                        profilePartyCategorys = yield PartyCategoryRepository_1.PartyCategoryRepository.find({
                            where: Object.assign({ profileId, updatedStamp: {
                                    $gt: lastSyncStamp || 0
                                } }, includeDeleted)
                        });
                    }
                    if (profilePartyCategorys && profilePartyCategorys.length) {
                        partyCategories.push(...profilePartyCategorys);
                    }
                }
            }
            let rawDocuments = partyCategories;
    ...
    permanentDeleteAll(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield PartyCategoryRepository_1.PartyCategoryRepository.delete({
                userId
            });
        });
    }
};
PartyCategoryService = __decorate([
    (0, typedi_1.Service)(),
...
exports.PartyCategoryService = PartyCategoryService;
//# sourceMappingURL=PartyCategoryService.js.map