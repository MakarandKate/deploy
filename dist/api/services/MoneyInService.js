...
let MoneyInService = class MoneyInService extends BaseService_1.BaseService {
    constructor(eventDispatcher) {
        super(MoneyInRepository_1.MoneyInRepository);
        this.eventDispatcher = eventDispatcher;
    }
    getDeleted() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield MoneyInRepository_1.MoneyInRepository.findDeleted();
        });
    }
    getAllDeleted(profileId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            let deletedMoneyIns = yield MoneyInRepository_1.MoneyInRepository.findBy({
                deletedStamp: { $gt: 0 },
                profileId,
                userId
            });
            deletedMoneyIns === null || deletedMoneyIns === void 0 ? void 0 : deletedMoneyIns.forEach(moneyIn => {
                moneyIn = nmi === null || nmi === void 0 ? void 0 : nmi.expand(moneyIn);
            });
            return deletedMoneyIns;
        });
    }
    getByUUID(uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            return MoneyInRepository_1.MoneyInRepository.findOneBy({
                _localUUID: uuid,
            });
        });
    }
    getByOldFirebaseId(oldFirebaseId) {
        return __awaiter(this, void 0, void 0, function* () {
            return MoneyInRepository_1.MoneyInRepository.findOneBy({ oldFirebaseId });
        });
    }
    save(document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let checkDocument = yield MoneyInRepository_1.MoneyInRepository.findOne({
                where: {
            ...
            checkDocument = nmi.expand(checkDocument);
            if (checkDocument != null) {
                if (checkDocument.updatedStamp < document.updatedStamp) {
                    document._is = +new Date();
                    document = nmi.compress(document);
                    let updateResult = yield MoneyInRepository_1.MoneyInRepository.updateMany({
                        _localUUID: checkDocument._localUUID
                    }, {
                        "$set": Object.assign({}, document)
                    });
                    let savedDocument = yield MoneyInRepository_1.MoneyInRepository.findOne({
                        where: {
                            _localUUID: document._localUUID,
                            profileId: document.profileId
                        },
                    ...
                    savedDocument = nmi.expand(savedDocument);
                ...
                document._is = +new Date();
                document = nmi.compress(document);
                let savedDocument = yield MoneyInRepository_1.MoneyInRepository.save(document);
                savedDocument = nmi.expand(savedDocument);
                savedDocument._serverIdRef = savedDocument._id.toString();
                savedDocument._localId = localId;
    ...
    saveAll(parties, phone) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < (parties === null || parties === void 0 ? void 0 : parties.length); i++) {
                ...
                savedMoneyIns.push(yield this.save(party));
            }
            return savedMoneyIns;
        });
    }
    fetchAll(phone, lastSyncStamp, accessProfiles) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (userIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                moneyIns = yield MoneyInRepository_1.MoneyInRepository.find({
            ...
            if ((accessProfiles === null || accessProfiles === void 0 ? void 0 : accessProfiles.length) > 0) {
                for (let i = 0; i < accessProfiles.length; i++) {
                    ...
                    if (profileIdCollectionStamp > lastSyncStamp || lastSyncStamp == 0) {
                        profileMoneyIns = yield MoneyInRepository_1.MoneyInRepository.find({
                            where: Object.assign({ profileId, updatedStamp: {
                                    $gt: lastSyncStamp || 0
                                } }, includeDeleted)
                        });
                    }
                    if (profileMoneyIns && profileMoneyIns.length) {
                        moneyIns.push(...profileMoneyIns);
                    }
                }
            }
            let rawDocuments = moneyIns;
    ...
    permanentDeleteAll(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield MoneyInRepository_1.MoneyInRepository.delete({
                userId
            });
        });
    }
    getMoneyInReport(phone, lastSyncStamp) {
        return __awaiter(this, void 0, void 0, function* () {
            let rawDocuments = yield MoneyInRepository_1.MoneyInRepository.find({
                where: {
                    userId: phone,
                    updatedStamp: {
                        $gt: lastSyncStamp || 0,
    ...
    getNewMoneyInNo(userId, profileId) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                moneyIns === null || moneyIns === void 0 ? void 0 : moneyIns.sort((a, b) => {
                ...
                if ((_a = moneyIns[0]) === null || _a === void 0 ? void 0 : _a.billNo) {
                    nextSaleNo = Utils_1.default.nextNo(moneyIns[0].billNo);
                }
