...
exports.duplicateItemCategoryRouter = void 0;
const ItemCategoryRepository_1 = require("../../api/repositories/ItemCategoryRepository");
const duplicateItemCategoryRouter = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let duprs = yield ItemCategoryRepository_1.ItemCategoryRepository.aggregate([
        {
            $match: {
    ...
    for (let i = 0; i < arr.length; i++) {
        let el = arr[i];
        let allDocs = yield ItemCategoryRepository_1.ItemCategoryRepository.find({
            where: {
        ...
        allDocs.shift();
        allDocs.forEach((el) => {
            ItemCategoryRepository_1.ItemCategoryRepository.delete(el._id);
        });
    }
    res.send({ arr });
});
exports.duplicateItemCategoryRouter = duplicateItemCategoryRouter;
