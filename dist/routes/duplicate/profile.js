...
exports.duplicateProfileRouter = void 0;
const ProfileRepository_1 = require("../../api/repositories/ProfileRepository");
const duplicateProfileRouter = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let duprs = yield ProfileRepository_1.ProfileRepository.aggregate([
        {
            $match: {
    ...
    for (let i = 0; i < arr.length; i++) {
        let el = arr[i];
        let allDocs = yield ProfileRepository_1.ProfileRepository.find({
            where: {
        ...
        allDocs.shift();
        allDocs.forEach((el) => {
            ProfileRepository_1.ProfileRepository.delete(el._id);
        });
    }
    res.send({ arr });
});
exports.duplicateProfileRouter = duplicateProfileRouter;
