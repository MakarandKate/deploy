...
exports.duplicatePurchaseRouter = void 0;
const PurchaseRepository_1 = require("../../api/repositories/PurchaseRepository");
const duplicatePurchaseRouter = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let duprs = yield PurchaseRepository_1.PurchaseRepository.aggregate([
        {
            $match: {
    ...
    for (let i = 0; i < arr.length; i++) {
        let el = arr[i];
        let allDocs = yield PurchaseRepository_1.PurchaseRepository.find({
            where: {
        ...
        allDocs.shift();
        allDocs.forEach((el) => {
            PurchaseRepository_1.PurchaseRepository.delete(el._id);
        });
    }
    res.send({ arr });
});
exports.duplicatePurchaseRouter = duplicatePurchaseRouter;
