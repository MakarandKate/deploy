...
exports.duplicateMoneyOutRouter = void 0;
const MoneyOutRepository_1 = require("../../api/repositories/MoneyOutRepository");
const duplicateMoneyOutRouter = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let duprs = yield MoneyOutRepository_1.MoneyOutRepository.aggregate([
        {
            $match: {
    ...
    for (let i = 0; i < arr.length; i++) {
        let el = arr[i];
        let allDocs = yield MoneyOutRepository_1.MoneyOutRepository.find({
            where: {
        ...
        allDocs.shift();
        allDocs.forEach((el) => {
            MoneyOutRepository_1.MoneyOutRepository.delete(el._id);
        });
    }
    res.send({ arr });
});
exports.duplicateMoneyOutRouter = duplicateMoneyOutRouter;
