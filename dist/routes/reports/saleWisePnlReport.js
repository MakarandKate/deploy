...
exports.saleWisePnlReport = void 0;
...
const saleWisePnlReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    ...
    if (phone && profileId) {
        ...
        let saleWisePnlReportData = yield reportService.getSaleWisePnlReportData(phone, profileId, startStamp, endStamp);
        (0, Page_1.setPage)(req, res, {
            title: 'Sale Wise Pnl Report',
            description: '',
            view: 'reports/saleWisePnlReport',
            data: {
                profile,
...
exports.saleWisePnlReport = saleWisePnlReport;
//# sourceMappingURL=saleWisePnlReport.js.map