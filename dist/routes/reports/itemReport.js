...
const itemReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    ...
    let itemUUID = (_e = req === null || req === void 0 ? void 0 : req.query) === null || _e === void 0 ? void 0 : _e.itemUUID;
    if (phone && profileId && startStamp && endStamp && itemUUID) {
        let profile = yield reportService.getProfile(phone, profileId);
        let itemReportData = yield reportService.getItemReportData(phone, profileId, startStamp, endStamp, itemUUID);
        (0, Page_1.setPage)(req, res, {
            title: 'Item Report',
            description: '',
            view: 'reports/itemReport',
            data: {
                profile,
                itemReportData
            },
