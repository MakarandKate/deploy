...
const itemSaleReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    ...
    if (phone && profileId) {
        ...
        let itemSaleReportData = yield reportService.getItemSaleReportData(phone, profileId, startStamp, endStamp);
        (0, Page_1.setPage)(req, res, {
            title: 'Item Sale Report',
            description: '',
            view: 'reports/itemSaleReport',
            data: {
                profile,
                itemSaleReportData
            },
...
exports.itemSaleReport = itemSaleReport;
//# sourceMappingURL=itemSaleReport.js.map