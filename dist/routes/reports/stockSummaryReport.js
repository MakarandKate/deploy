...
exports.stockSummaryReport = void 0;
...
const stockSummaryReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    if (phone && profileId) {
        ...
        let stockSummaryReportData = yield reportService.getStockSummaryReportData(phone, profileId);
        (0, Page_1.setPage)(req, res, {
            title: 'Stock Summary Report',
            description: '',
            view: 'reports/stockSummaryReport',
            data: {
                profile,
...
exports.stockSummaryReport = stockSummaryReport;
//# sourceMappingURL=stockSummaryReport.js.map