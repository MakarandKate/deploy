...
const saleReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (phone && profileId) {
        ...
        let saleReportData = yield reportService.getSaleReportData(phone, profileId, startStamp, endStamp);
        (0, Page_1.setPage)(req, res, {
            title: 'Sale Report',
            description: '',
            view: 'reports/saleReport',
            data: {
                profile,
                saleReportData
            },
...
//# sourceMappingURL=saleReport.js.map